...
module.exports = function (req, res, next) {
    ...
    try { const decoded = jwt.verify(token, config.get('jwtSecret')); req.user = decoded; console.log('decoded ', decoded); next(); return; }
    catch (e) { console.log('error ', e); req.user = null; next(); return; }
}